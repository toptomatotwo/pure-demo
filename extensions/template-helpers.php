 ...
 * @return void
 */
if ( ! function_exists( 'puredemo_postby_meta' ) ):
function puredemo_postby_meta() {
 ...
 * @return void
 */
if ( ! function_exists( 'puredemo_footer_meta' ) ):
function puredemo_footer_meta( $post ) {
...
if ( ! function_exists( 'puredemo_paging_nav' ) ) :
/**
 ...
 * @return void
 */
function puredemo_paging_nav( $query = false ) {
	global $wp_query;
	if ( $query ) {
		$temp_query = $wp_query;
		$wp_query = $query;
...
if ( ! function_exists( 'puredemo_post_nav' ) ) :
/**
 * Display navigation to next/previous post when applicable.
 *
 * @return void
 */
function puredemo_post_nav() {

	if ( ! puredemo_get_option( 'postnav', false ) ) {
		return;
	}
