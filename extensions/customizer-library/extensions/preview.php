 ...
 */
function puredemo_upgrade_notice() {

	$path = str_replace( WP_CONTENT_DIR, WP_CONTENT_URL, dirname( dirname( __FILE__ ) ) );

	wp_enqueue_script( 'puredemo_upgrade', $path . '/js/upgrade.js', array(), '1.0.0', true );
...
add_action( 'customize_controls_enqueue_scripts', 'puredemo_upgrade_notice' );
